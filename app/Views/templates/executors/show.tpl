...
{block name="content"}
    ...
    <!-- Аналітичні показники виконавця -->
    <div class="row mb-4">
        <div class="col-md-3">
            <div class="card bg-success text-white">
                <div class="card-body text-center">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="mb-0">{$executorStats.completion_rate}%</h4>
                            <small>Ефективність</small>
                        </div>
        ...
        <div class="col-md-3">
            <div class="card bg-primary text-white">
                <div class="card-body text-center">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="mb-0">{$executorStats.total_orders}</h4>
        ...
        <div class="col-md-3">
            <div class="card bg-info text-white">
                <div class="card-body text-center">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="mb-0">{$executorStats.avg_completion_days|round:1}</h4>
        ...
        <div class="col-md-3">
            <div class="card bg-warning text-white">
                <div class="card-body text-center">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="mb-0">{$executorStats.performance_score}</h4>
                            <small>Оцінка продуктивності</small>
                        </div>

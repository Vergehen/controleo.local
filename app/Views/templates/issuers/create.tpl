...
{block name="content"}
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1>Створення нового видавця</h1>
        <a href="/issuers" class="btn btn-outline-secondary">Скасувати</a>
    </div>

    <div class="card">
        <div class="card-body">
            <form action="/issuers" method="POST" class="needs-validation" novalidate>
                <div class="row mb-3">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="issuer_contact" name="issuer_contact">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="issuer_notes" name="issuer_notes" rows="3"></textarea>
                </div>

                <div class="d-grid">
                    <button type="submit" class="btn btn-primary">Створити видавця</button>
                </div>
            </form>
        </div>
    </div>
